...
module.exports = async function (context, req) {
    ...
    try {
        ...
        if (tasksToUpdate.length === 0) {
            context.res = { status: 200, body: "Nenhuma tarefa encontrada para este projeto." };
            return;
        }
        ...
        context.res = { status: 200, body: `Cor do projeto '${projectName}' atualizada com sucesso.` };
        
    } catch (error) {
        context.log.error(`Erro ao atualizar cor do projeto: ${error.message}`);
        context.res = { status: 500, body: "Erro interno ao atualizar a cor do projeto." };
    }
};